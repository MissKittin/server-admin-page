<?php
	...
	{ ?>
		&#9500;&#9472;Sample submenu<br>
			&#9500;&#9472;&#9472;<a href="<?php echo $system['location_html']; ?>/power?do=thing" onclick="return confirm('Are you sure?');">Thing</a><br>
			&#9500;&#9472;&#9472;<a href="<?php echo $system['location_html']; ?>/power?do=anotherThing" onclick="return confirm('Are you sure?');">Another Thing</a><br>
	<?php }
?>
